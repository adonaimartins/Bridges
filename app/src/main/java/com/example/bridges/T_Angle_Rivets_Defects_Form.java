...
public class T_Angle_Rivets_Defects_Form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t__angle__rivets__defects__form);
        ...
        dropDown_position.addSpinnerValues(findViewById(R.id.dropDown_defect_type_p44), position_items);
    }
