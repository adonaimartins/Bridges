...
public class Girder_Form extends AppCompatActivity{
    ...
    private Dropdown dropDown_bays_direction = new Dropdown("Select Direction");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter elevation_items = new ArrayAdapter<String>(
                this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.elevation));//resourseNameArray
