...
@Entity(tableName = "L_AnglesRivetsDefects", foreignKeys = @ForeignKey(entity = L_AnglesRivets.class,
...
public class L_AnglesRivetsDefects {
    ...
    public L_AnglesRivetsDefects(int rivet_id, String type, double percentegeLoss, int numberAfected, int sync_status) {
