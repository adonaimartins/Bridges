...
@Entity(tableName = "FlangesRivetsDefects", foreignKeys = @ForeignKey(entity = FlangesRivets.class,
...
public class FlangesRivetsDefects {

    @PrimaryKey(autoGenerate = true)
    private int defect_id; //INT AUTO_INCREMENT PRIMARY KEY


    private int rivet_id; // INT NOT NULL,FOREIGN KEY (rivet_id) REFERENCES FlangesRivets(rivet_id)
    private String type;
    private double percentegeLoss;
    private int numberAfected;
    private int sync_status;

    public FlangesRivetsDefects(int rivet_id, String type, double percentegeLoss, int numberAfected, int sync_status) {
