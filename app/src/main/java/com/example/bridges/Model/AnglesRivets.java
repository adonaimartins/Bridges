...
@Entity(tableName = "AnglesRivets", foreignKeys = @ForeignKey(entity = Angles.class,
...
public class AnglesRivets {
    ...
    public AnglesRivets(int angle_id, String type, int headSize, int longitudinalSpacing1, int transverseSpacing1, int transverseSpacing2, int numberOfRivets, int sync_status) {
