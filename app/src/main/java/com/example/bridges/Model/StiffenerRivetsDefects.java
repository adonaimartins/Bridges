...
@Entity(tableName = "StiffenerRivetsDefects", foreignKeys = @ForeignKey(entity = StiffenerRivets.class,
...
public class StiffenerRivetsDefects {
    ...
    public StiffenerRivetsDefects(int rivet_id, String type, double percentegeLoss, int numberAfected, int sync_status) {
