...
@Entity(tableName = "AnglesRivetsDefects", foreignKeys = @ForeignKey(entity = AnglesRivets.class,
...
public class AnglesRivetsDefects {
    ...
    public AnglesRivetsDefects(int rivet_id, String type, double percentegeLoss, int numberAfected, int sync_status) {
