...
@Entity(tableName = "T_AnglesRivetsDefects", foreignKeys = @ForeignKey(entity = T_AnglesRivets.class,
...
public class T_AnglesRivetsDefects {
    ...
    public T_AnglesRivetsDefects(int rivet_id, String type, double percentegeLoss, int numberAfected, int sync_status) {
