...
@Entity(tableName = "BackToBackL_Angles", foreignKeys = @ForeignKey(entity = Stiffener.class,
...
public class BackToBackL_Angles {
    ...
    public BackToBackL_Angles(int stiffener_id, int length_mm, int height_mm, int width_top_mm, int width_bottom_mm, int thickness_mm, double length_inches, double height_inches, double width_top_inches, double width_bottom_inches, double thickness_inches, String preffered_unit, int sync_status) {
    ...
    public void setB2b_l_angle_id(int b2b_l_angle_id) {
